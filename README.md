...
![shadch-landing-page](https://github.com/)

Build your React landing page effortlessly with the required sections to your project. <a href="https://hiring-platform-su.netlify.app/" target="_blank">Live Demo</a>
...
```bash
cd hiring-platform_landing-page
```
